...
- **Agentic Monitoring for AI Control** (supervised by [Tyler Tracy](https://www.tylertracy.com/))
...
- **Cooperation and Control in Markov Delegation Games** (supervised by [Lewis Hammond](https://lewishammond.com/) and [Oly Sourbut](https://uk.linkedin.com/in/oliver-sourbut))
...
- **Games for AI Control** (in collaboration with [Charlie Griffin](https://www.cs.ox.ac.uk/people/charlie.griffin/); supervised by [Alessandro Abate](https://www.cs.ox.ac.uk/people/alessandro.abate/) and [Buck Shlegeris](https://www.shlegeris.com/))
...
- Towards shutdownable agents via stochastic choice (supervised by [Elliott Thornley](https://www.elliott-thornley.com/))
...
- Tall Tales at Different Scales: Evaluating Scaling Trends For Deception In Language Models (supervised by [Francis Rhys Ward](https://francisrhysward.wordpress.com/))
